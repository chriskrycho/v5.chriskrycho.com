...
global $siteEmail;
global $mainSiteByline;
global $universalHome;
global $stylesheetUrl;
...
<head>
   ...
   <!-- Styles -->
   <link rel="stylesheet" type="text/css" media="screen" href="<? echo $stylesheetUrl; ?>" />
   <link rel="stylesheet" type="text/css" media="print" href="<? echo $stylesheetDirectory; ?>/print.css" />

   <!-- Site specific stylesheet -->
   <link rel="stylesheet" type="text/css" media="screen" href="<? echo $stylesheetDirectory; ?>/styles/home.css" />
...
<body>
   <div id="decorative-wrapper">
      ...
      <header id="site-header">
         ...
         <h2><i><? echo $siteDescription; ?> <span class="break">by <? echo $mainSiteByline; ?></span></i></h2>
      </header>

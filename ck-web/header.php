...
<head>
   ...
   <!-- jQuery -->
   <script type="text/javascript" src="<?php echo $universalHome ?>utilities/jquery.min.js"></script>
   <script type="text/javascript" src="<?php echo $universalHome ?>utilities/tooltip/jquery.tooltip.min.js"></script>
   <script type="text/javascript" src="<?php echo $universalHome ?>utilities/custom-functions.js"></script>

   <!-- IE Fixes -->
   <!--[if lt IE 9]>
      <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
      <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $stylesheetDirectory; ?>/styles/ie.css" />
   <![endif]-->
...
<div id="decorative-wrapper">
   ...
   <header id="site-header">
      <h1><?php echo '<a href="' . $homeUrl . '">' . $siteName . '</a>'; ?></h1>
      <h2><span class="italic"><?php echo $siteDescription; ?> <span class="break">by <?php echo $subSiteByline; ?></span></span></h2>
   </header>

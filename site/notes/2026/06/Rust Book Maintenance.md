...
We [disclaim in the <span class="all-smcp">README</span>][contributing] what the maintenance approach is, and why—time and print, both of which complicate maintenance on it a *lot*—but it’s still not great to have so many open issues and <abbr title="pull request">PR</abbr>s unaddressed. I’d love to change that. But also: Carol and I both have other full-time jobs and the book doesn’t have any ongoing funding! It’s a tough problem and I don’t know how to solve it.

...
In software, the stock of a code base is its sustaining capacity to deliver the flow of new end-user capabilities over time.[^static] Any improved ability to understand, to navigate, and to change our code are all improved stocks. Even making complexity visible rather than invisible, as in the case of many JavaScript-to-TypeScript conversions, is an improvement to a stock. Investing in these sorts of non-functional changes to code which make it easier to work with later is therefore not “achieving nothing”. It is, rather, investing in the future of the system.
